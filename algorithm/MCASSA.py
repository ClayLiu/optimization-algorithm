...
func1 = lambda x, y: x**2 + y**2 + 25 * (math.sin(x) ** 2 + math.sin(y) ** 2)
func2 = lambda x, y: x**2 + y**2 + 25 * (math.sin(x) ** 2 + math.sin(y) ** 2)
...
bounds = ((-2*math.pi, 2*math.pi), (-2*math.pi, 2*math.pi))
salp_num = 30
iter_num = 1000
thresh = 100
mesh_div = 100
